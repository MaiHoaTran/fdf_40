  ...
  class UsersController < ApplicationController
    ...
    def update
      if @user.update user_params
        flash[:success] = I18n.t "admin.users.edit.success_edit_msg"
    ...
    def user_params
      params.require(:user).permit :full_name, :email, :password, :password_confirmation, :phone, :address, :sex, :roles
    end
